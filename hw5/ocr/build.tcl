...
set files [list \
 ...
 [file normalize "$origin_dir/src/soc_rtl/float_clint.v" ]\
...
set_property -dict [ list \
   ...
   CONFIG.c_latency {2} ] [get_ips floating_point_0]
generate_target all [get_files ${proj_name}/${proj_name}.srcs/sources_1/ip/floating_point_0/floating_point_0.xci]
update_compile_order -fileset sources_1
set_property IS_ENABLED 0 [get_files ${proj_name}/${proj_name}.${gen_srcs}/sources_1/ip/floating_point_0/floating_point_0_ooc.xdc]
